...
// Sub-app B — own process / main
static constexpr int kAppId = 2;
static constexpr const char *kAppName = "subapp-b";
...
int main(int argc, char *argv[])
{
    ...
    parser.setApplicationDescription(QStringLiteral("Sub-app B"));
